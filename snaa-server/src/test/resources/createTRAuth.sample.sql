...
insert into URN_RESOURCEGROUPS (URN, RESOURCEGROUP) values ('urn:wisebed:ulanc1:0x1211', 'EXPERIMENT_NODES');
insert into URN_RESOURCEGROUPS (URN, RESOURCEGROUP) values ('urn:wisebed:ulanc1:0x1212', 'EXPERIMENT_NODES');
insert into URN_RESOURCEGROUPS (URN, RESOURCEGROUP) values ('urn:wisebed:ulanc1:0x1213', 'EXPERIMENT_NODES');
insert into URN_RESOURCEGROUPS (URN, RESOURCEGROUP) values ('urn:wisebed:ulanc1:0x1311', 'SERVICE_NODES');
insert into URN_RESOURCEGROUPS (URN, RESOURCEGROUP) values ('urn:wisebed:ulanc1:0x1312', 'SERVICE_NODES');
insert into URN_RESOURCEGROUPS (URN, RESOURCEGROUP) values ('urn:wisebed:ulanc1:0x1313', 'SERVICE_NODES');

insert into URN_RESOURCEGROUPS (URN, RESOURCEGROUP) values ('urn:wisebed:uzl2:0x2211', 'EXPERIMENT_NODES');
insert into URN_RESOURCEGROUPS (URN, RESOURCEGROUP) values ('urn:wisebed:uzl2:0x2212', 'EXPERIMENT_NODES');
insert into URN_RESOURCEGROUPS (URN, RESOURCEGROUP) values ('urn:wisebed:uzl2:0x2213', 'EXPERIMENT_NODES');
insert into URN_RESOURCEGROUPS (URN, RESOURCEGROUP) values ('urn:wisebed:uzl2:0x2311', 'SERVICE_NODES');
insert into URN_RESOURCEGROUPS (URN, RESOURCEGROUP) values ('urn:wisebed:uzl2:0x2312', 'SERVICE_NODES');
insert into URN_RESOURCEGROUPS (URN, RESOURCEGROUP) values ('urn:wisebed:uzl2:0x2313', 'SERVICE_NODES');

DROP TABLE IF EXISTS USERS;
CREATE TABLE USERS ( NAME VARCHAR(150) NOT NULL, PASSWORD VARCHAR(1500), SALT VARCHAR(1500), PRIMARY KEY (NAME) ) ;
insert into USERS (NAME, PASSWORD, SALT) values ('Experimenter1', 'Exp1Pass', 'Exp1Salt');
insert into USERS (NAME, PASSWORD, SALT) values ('Administrator1', 'Adm1Pass', 'Adm1Salt');
insert into USERS (NAME, PASSWORD, SALT) values ('ServiceProvider1', 'SP1Pass', 'SP1Salt');
